...
contract("Dex", accounts => {
    ...
    it("should throw an error if ETH balance is too low when creating BUY limit order", async () => {
        ...
        dex.addToken(web3.utils.fromUtf8("ETH"), link.address, { from: accounts[0] })
    ...
    it("should throw an error if token balance is too low when creating SELL limit order", async () => {
        ...
        let link = await Link.deployed()
        await truffleAssert.reverts(
            dex.createLimitOrder(1, web3.utils.fromUtf8("ETH"), 11, 1)
        )
        dex.addToken(web3.utils.fromUtf8("ETH"), link.address, { from: accounts[0] })
        await link.approve(dex.address, 500);
        await dex.deposit(10, web3.utils.fromUtf8("ETH"));
        await truffleAssert.passes(
            dex.createLimitOrder(1, web3.utils.fromUtf8("ETH"), 10, 1)
        )
    })
    ...
    it("The BUY order book should be ordered on price from highest to lowest starting at index 0", async () => {
        ...
        await dex.deposit(600, web3.utils.fromUtf8("ETH"));
        await dex.createLimitOrder(0, web3.utils.fromUtf8("ETH"), 1, 300)
        await dex.createLimitOrder(0, web3.utils.fromUtf8("ETH"), 1, 100)
        await dex.createLimitOrder(0, web3.utils.fromUtf8("ETH"), 1, 200)
    ...
    it("The SELL order book should be ordered on price from lowest to highest starting at index 0", async () => {
        ...
        let link = await Link.deployed()
        await link.approve(dex.address, 700);
        await dex.createLimitOrder(1, web3.utils.fromUtf8("ETH"), 1, 300)
        await dex.createLimitOrder(1, web3.utils.fromUtf8("ETH"), 1, 100)
        await dex.createLimitOrder(1, web3.utils.fromUtf8("ETH"), 1, 200)
